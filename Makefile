...
HL2SDKL4D2 = ../hl2sdk-l4d2-9372f2ec8e75
MMSOURCE = ../metamod-source-1.10-dev
SOURCEMOD = ../sourcemod-central-568f4497ef4a

#####################################
### EDIT BELOW FOR OTHER PROJECTS ###
#####################################

PROJECT = bulldozer_chargers
OBJECTS = bulldozer_chargers.cpp memutils.cpp
...
CFLAGS += -Dstricmp=strcasecmp -D_stricmp=strcasecmp -D_strnicmp=strncasecmp \
	...
	-Dstrcmpi=strcasecmp -fPIC -fno-exceptions \
...
all:
	mkdir -p $(BIN_DIR)
	$(MAKE) -f Makefile bulldozer_chargers

bulldozer_chargers: $(OBJ_BIN)
